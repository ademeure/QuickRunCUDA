// Per-SM single-line latency at L2 (.cg bypasses L1)
#include <cuda_runtime.h>
#include <cstdio>
#include <cstdint>

__global__ void per_sm_chain_cg(uint32_t *p, uint64_t *out, int max_sms) {
...
int main(int argc, char**argv) {
    ...
    per_sm_chain_cg<<<2000, 32>>>((uint32_t*)((char*)d_p + offset), d_out, max_sms);
