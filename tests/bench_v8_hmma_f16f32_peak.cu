// V8: HMMA.F16 with F32 accumulator — ML training path
// mma.sync.aligned.m16n8k16.f32.f16.f16.f32
// Each warp: C/D = 4 × b32 (float) per thread; A = 4 × b32 (half); B = 2 × b32 (half)
#ifndef N_CHAINS
#define N_CHAINS 8
#endif
...
void kernel(float* A, float* B, float* C, int ITERS, int seed, int u2) {
    ...
    // F32 accumulator: 4 × b32 per thread, N_CHAINS independent
