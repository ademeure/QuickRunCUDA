// V6 C1: FFMA min-energy clock sweep (kernel)
// Run sustained FFMA for ITERS_OUTER outer iters
// Each thread does ITERS_OUTER × ITERS_INNER × 8 chains × 2 FLOP/FMA = X FLOPs
// Measure runtime + power externally
#ifndef ITERS_INNER
