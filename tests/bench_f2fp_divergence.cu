// F2FP with thread divergence — do some lanes stall the warp at F2FP rate?
#ifndef ACTIVE_LANES
#define ACTIVE_LANES 32   // 32 = full warp, 16 = half, etc.
#endif
#ifndef N_CHAINS
#define N_CHAINS 4
#endif
...
void kernel(float* A, float* B, float* C, int ITERS, int seed, int unused_2) {
    ...
    const bool active = (lane < ACTIVE_LANES);
